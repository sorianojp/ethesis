...
<head>
    <meta charset="utf-8">
    <title>Approval Form (Undergraduate)</title>
    <style>
        @page {
            size: A4;
...
<body>
    ...
    <p class="indent">
        ...
        <span style="font-weight: bold; text-transform: uppercase;">{{ $participantsLine }}</span>, are hereby endorsed
    ...
    <p class="indent">
        ...
        <span style="font-weight: bold; text-transform: uppercase;">{{ $participantsLine }}</span> has been examined
        and approved on <span style="font-weight: bold; text-transform: uppercase;">{{ $finalDefenseDate }}</span> by the
